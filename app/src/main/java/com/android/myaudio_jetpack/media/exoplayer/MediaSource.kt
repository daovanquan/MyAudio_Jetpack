package com.android.myaudio_jetpack.media.exoplayer

import android.support.v4.media.MediaBrowserCompat
import android.support.v4.media.MediaDescriptionCompat
import android.support.v4.media.MediaMetadataCompat
import com.android.myaudio_jetpack.data.repository.AudioRepository
...
@Inject constructor(private val repository: AudioRepository) {
    ...
    fun asMediaItem() = audioMediaMetaData.map { meta ->
        val description = MediaDescriptionCompat.Builder()
            .setTitle(meta.description.title)
            .setMediaId(meta.description.mediaId)
            .setSubtitle(meta.description.subtitle)
            .setMediaUri(meta.description.mediaUri)
            .build()
